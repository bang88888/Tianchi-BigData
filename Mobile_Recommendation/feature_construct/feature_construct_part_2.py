...
df_part_2_u_b_count_in_6 = df_part_2.drop_duplicates(['user_id','behavior_type'], keep='last')[['user_id','behavior_type','cumcount']]
...
df_part_2_u_b_count_in_6 = df_part_2_u_b_count_in_6.groupby('user_id').agg({'u_b1_count_in_6': 'sum',
                                                                            'u_b2_count_in_6': 'sum',
                                                                            'u_b3_count_in_6': 'sum',
                                                                            'u_b4_count_in_6': 'sum'})
...
# u_b_count_in_3
df_part_2_in_3 = df_part_2[df_part_2['time'] >= np.datetime64('2014-12-02')].copy()
df_part_2_in_3['cumcount'] = df_part_2_in_3.groupby(['user_id', 'behavior_type']).cumcount()
df_part_2_u_b_count_in_3 = df_part_2.drop_duplicates(['user_id','behavior_type'], keep='last')[['user_id','behavior_type','cumcount']]
...
df_part_2_u_b_count_in_3 = df_part_2_u_b_count_in_3.groupby('user_id').agg({'u_b1_count_in_3': 'sum',
                                                                            'u_b2_count_in_3': 'sum',
                                                                            'u_b3_count_in_3': 'sum',
                                                                            'u_b4_count_in_3': 'sum'})
...
# u_b_count_in_1
df_part_2_in_1 = df_part_2[df_part_2['time'] >= np.datetime64('2014-12-04')].copy()
df_part_2_in_1['cumcount'] = df_part_2_in_1.groupby(['user_id', 'behavior_type']).cumcount()
df_part_2_u_b_count_in_1 = df_part_2_in_1.drop_duplicates(['user_id','behavior_type'], keep='last')[['user_id','behavior_type','cumcount']]
...
df_part_2_u_b_count_in_1 = df_part_2_u_b_count_in_1.groupby('user_id').agg({'u_b1_count_in_1': 'sum',
                                                                            'u_b2_count_in_1': 'sum',
                                                                            'u_b3_count_in_1': 'sum',
                                                                            'u_b4_count_in_1': 'sum'})
...
df_part_2_u_b4_time = df_part_2[df_part_2['behavior_type'] == 4].drop_duplicates(['user_id'],keep='first')[['user_id','time']]
df_part_2_u_b4_time.columns = ['user_id','b4_first_time']
df_part_2_u_b_time = df_part_2.drop_duplicates(['user_id'],keep='first')[['user_id','time']]
...
# i_u_count_in_6
df_part_2_in_6 = df_part_2.drop_duplicates(['item_id', 'user_id']).copy()
df_part_2_in_6['i_u_count_in_6'] = df_part_2_in_6.groupby('item_id').cumcount() + 1
df_part_2_i_u_count_in_6 = df_part_2_in_6.drop_duplicates(['item_id'], keep='last')[['item_id', 'i_u_count_in_6']]
...
df_part_2_i_u_count_in_3 = df_part_2_in_3.drop_duplicates(['item_id'], keep='last')[['item_id', 'i_u_count_in_3']]
...
df_part_2_i_u_count_in_1 = df_part_2_in_1.drop_duplicates(['item_id'], keep='last')[['item_id', 'i_u_count_in_1']]
...
df_part_2_i_b_count_in_6 = df_part_2.drop_duplicates(['item_id','behavior_type'], keep='last')[['item_id','behavior_type','cumcount']]
...
df_part_2_i_b_count_in_6 = df_part_2_i_b_count_in_6[['item_id', 
                                                     ...
                                                     'i_b3_count_in_6',
                                                     'i_b4_count_in_6']]
df_part_2_i_b_count_in_6 = df_part_2_i_b_count_in_6.groupby('item_id').agg({'i_b1_count_in_6': 'sum',
                                                                            'i_b2_count_in_6': 'sum',
                                                                            'i_b3_count_in_6': 'sum',
                                                                            'i_b4_count_in_6': 'sum'})
...
df_part_2_i_b_count_in_3 = df_part_2.drop_duplicates(['item_id','behavior_type'], keep='last')[['item_id','behavior_type','cumcount']]
...
df_part_2_i_b_count_in_3 = df_part_2_i_b_count_in_3[['item_id', 
                                                     ...
                                                     'i_b3_count_in_3',
                                                     'i_b4_count_in_3']]
df_part_2_i_b_count_in_3 = df_part_2_i_b_count_in_3.groupby('item_id').agg({'i_b1_count_in_3': 'sum',
                                                                            'i_b2_count_in_3': 'sum',
                                                                            'i_b3_count_in_3': 'sum',
                                                                            'i_b4_count_in_3': 'sum'})
...
df_part_2_i_b_count_in_1 = df_part_2_in_1.drop_duplicates(['item_id','behavior_type'], keep='last')[['item_id','behavior_type','cumcount']]
...
df_part_2_i_b_count_in_1 = df_part_2_i_b_count_in_1[['item_id', 
                                                     ...
                                                     'i_b3_count_in_1',
                                                     'i_b4_count_in_1']]
df_part_2_i_b_count_in_1 = df_part_2_i_b_count_in_1.groupby('item_id').agg({'i_b1_count_in_1': 'sum',
                                                                            'i_b2_count_in_1': 'sum',
                                                                            'i_b3_count_in_1': 'sum',
                                                                            'i_b4_count_in_1': 'sum'})
...
df_part_2_i_b4_time = df_part_2[df_part_2['behavior_type'] == 4].drop_duplicates(['item_id'], keep='first')[['item_id','time']]
df_part_2_i_b4_time.columns = ['item_id','b4_first_time']
df_part_2_i_b_time = df_part_2.drop_duplicates(['item_id'], keep='first')[['item_id','time']]
...
# c_u_count_in_6
df_part_2_in_6 = df_part_2.drop_duplicates(['item_category', 'user_id']).copy()
df_part_2_in_6['c_u_count_in_6'] = df_part_2_in_6.groupby('item_category').cumcount() + 1
df_part_2_c_u_count_in_6 = df_part_2_in_6.drop_duplicates(['item_category'], keep='last')[['item_category', 'c_u_count_in_6']]
...
df_part_2_c_u_count_in_3 = df_part_2_in_3.drop_duplicates(['item_category'], keep='last')[['item_category', 'c_u_count_in_3']]
...
df_part_2_c_u_count_in_1 = df_part_2_in_1.drop_duplicates(['item_category'], keep='last')[['item_category', 'c_u_count_in_1']]
...
df_part_2_c_b_count_in_6 = df_part_2.drop_duplicates(['item_category','behavior_type'], keep='last')[['item_category','behavior_type','cumcount']]
...
df_part_2_c_b_count_in_6 = df_part_2_c_b_count_in_6[['item_category', 
                                                     ...
                                                     'c_b3_count_in_6',
                                                     'c_b4_count_in_6']]
df_part_2_c_b_count_in_6 = df_part_2_c_b_count_in_6.groupby('item_category').agg({'c_b1_count_in_6': 'sum',
                                                                                  'c_b2_count_in_6': 'sum',
                                                                                  'c_b3_count_in_6': 'sum',
                                                                                  'c_b4_count_in_6': 'sum'})
...
df_part_2_c_b_count_in_3 = df_part_2_in_3.drop_duplicates(['item_category','behavior_type'], keep='last')[['item_category','behavior_type','cumcount']]
...
df_part_2_c_b_count_in_3 = df_part_2_c_b_count_in_3[['item_category', 
                                                     ...
                                                     'c_b3_count_in_3',
                                                     'c_b4_count_in_3']]
df_part_2_c_b_count_in_3 = df_part_2_c_b_count_in_3.groupby('item_category').agg({'c_b1_count_in_3': 'sum',
                                                                                  'c_b2_count_in_3': 'sum',
                                                                                  'c_b3_count_in_3': 'sum',
                                                                                  'c_b4_count_in_3': 'sum'})
...
df_part_2_c_b_count_in_1 = df_part_2_in_1.drop_duplicates(['item_category','behavior_type'], keep='last')[['item_category','behavior_type','cumcount']]
...
df_part_2_c_b_count_in_1 = df_part_2_c_b_count_in_1[['item_category', 
                                                     ...
                                                     'c_b3_count_in_1',
                                                     'c_b4_count_in_1']]
df_part_2_c_b_count_in_1 = df_part_2_c_b_count_in_1.groupby('item_category').agg({'c_b1_count_in_1': 'sum',
                                                                                  'c_b2_count_in_1': 'sum',
                                                                                  'c_b3_count_in_1': 'sum',
                                                                                  'c_b4_count_in_1': 'sum'})
...
df_part_2_c_b4_time = df_part_2[df_part_2['behavior_type'] == 4].drop_duplicates(['item_category'], keep='first')[['item_category','time']]
df_part_2_c_b4_time.columns = ['item_category','b4_first_time']
df_part_2_c_b_time = df_part_2.drop_duplicates(['item_category'], keep='first')[['item_category','time']]
...
df_part_2_ui_b_count_in_6 = df_part_2.drop_duplicates(['user_id','item_id','behavior_type'],keep='last')[['user_id','item_id','behavior_type','cumcount']]
...
df_part_2_ui_b_count_in_6 = df_part_2_ui_b_count_in_6[['user_id', 
                                                       ...
                                                       'ui_b3_count_in_6',
                                                       'ui_b4_count_in_6']]
df_part_2_ui_b_count_in_6 = df_part_2_ui_b_count_in_6.groupby(['user_id', 'item_id']).agg({'ui_b1_count_in_6': 'sum',
...
df_part_2_ui_b_count_in_3 = df_part_2.drop_duplicates(['user_id','item_id','behavior_type'],keep='last')[['user_id','item_id','behavior_type','cumcount']]
...
df_part_2_ui_b_count_in_3 = df_part_2_ui_b_count_in_3[['user_id', 
                                                       ...
                                                       'ui_b3_count_in_3',
                                                       'ui_b4_count_in_3']]
df_part_2_ui_b_count_in_3 = df_part_2_ui_b_count_in_3.groupby(['user_id', 'item_id']).agg({'ui_b1_count_in_3': 'sum',
...
df_part_2_ui_b_count_in_1 = df_part_2_in_1.drop_duplicates(['user_id','item_id','behavior_type'], keep='last')[['user_id','item_id','behavior_type','cumcount']]
...
df_part_2_ui_b_count_in_1 = df_part_2_ui_b_count_in_1[['user_id',
                                                       ...
                                                       'ui_b3_count_in_1',
                                                       'ui_b4_count_in_1']]
df_part_2_ui_b_count_in_1 = df_part_2_ui_b_count_in_1.groupby(['user_id', 'item_id']).agg({'ui_b1_count_in_1': 'sum',
...
df_part_2_ui_b_last_time = df_part_2.drop_duplicates(['user_id','item_id','behavior_type'],keep='last')[['user_id','item_id','behavior_type','time']]
...
df_part_2_ui_b_last_time = df_part_2_ui_b_last_time.groupby(['user_id', 'item_id']).agg({'ui_b1_last_hours': 'sum',
...
df_part_2_uc_b_count_in_6 = df_part_2.drop_duplicates(['user_id','item_category','behavior_type'],keep='last')[['user_id','item_category','behavior_type','cumcount']]
...
df_part_2_uc_b_count_in_6 = df_part_2_uc_b_count_in_6[['user_id', 
                                                       ...
                                                       'uc_b3_count_in_6',
                                                       'uc_b4_count_in_6']]
df_part_2_uc_b_count_in_6 = df_part_2_uc_b_count_in_6.groupby(['user_id', 'item_category']).agg({'uc_b1_count_in_6': 'sum',
...
df_part_2_uc_b_count_in_3 = df_part_2.drop_duplicates(['user_id','item_category','behavior_type'],keep='last')[['user_id','item_category','behavior_type','cumcount']]
...
df_part_2_uc_b_count_in_3 = df_part_2_uc_b_count_in_3[['user_id', 
                                                       ...
                                                       'uc_b3_count_in_3',
                                                       'uc_b4_count_in_3']]
df_part_2_uc_b_count_in_3 = df_part_2_uc_b_count_in_3.groupby(['user_id', 'item_category']).agg({'uc_b1_count_in_3': 'sum',
...
df_part_2_uc_b_count_in_1 = df_part_2_in_1.drop_duplicates(['user_id','item_category','behavior_type'], keep='last')[['user_id','item_category','behavior_type','cumcount']]
...
df_part_2_uc_b_count_in_1 = df_part_2_uc_b_count_in_1[['user_id',
                                                       ...
                                                       'uc_b3_count_in_1',
                                                       'uc_b4_count_in_1']]
df_part_2_uc_b_count_in_1 = df_part_2_uc_b_count_in_1.groupby(['user_id', 'item_category']).agg({'uc_b1_count_in_1': 'sum',
...
df_part_2_uc_b_last_time = df_part_2.drop_duplicates(['user_id','item_category','behavior_type'],keep='last')[['user_id','item_category','behavior_type','time']]
...
df_part_2_uc_b_last_time = df_part_2_uc_b_last_time.groupby(['user_id', 'item_category']).agg({'uc_b1_last_hours': 'sum',
